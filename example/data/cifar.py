...
class Cifar:
    def __init__(self, percentage, batch_size, threads):
        ...
        self.train_set = Cifar10Subset(percentage=percentage, root='./data', train=True, transform=train_transform)
        self.test_set = Cifar10Subset(percentage=percentage, root='./data', train=False, transform=test_transform)
